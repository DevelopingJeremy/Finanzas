<div class="page-header">
    <div>
        <h1>🏷️ <?= $accion ?> Categoría</h1>
    </div>
    <a href="/public/?c=categorias&a=index" class="btn btn-secondary">← Volver</a>
</div>
...
<div class="card" style="max-width:520px;">
    ...
    <form method="POST">
        ...
        <div style="display:flex;gap:.75rem;margin-top:1rem;">
            ...
            <a href="/public/?c=categorias&a=index" class="btn btn-secondary">Cancelar</a>
        </div>
    </form>
</div>