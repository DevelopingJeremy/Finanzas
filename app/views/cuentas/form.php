<div class="page-header">
    ...
    <a href="/public/?c=cuentas&a=index" class="btn btn-secondary">← Volver</a>
</div>
    ...
    <form method="POST">
        <div class="form-group">
            ...
            <input type="text" id="nombre" name="nombre" class="form-control"
                value="<?= htmlspecialchars($cuenta['nombre'] ?? '') ?>" placeholder="Ej: BAC Colones, Efectivo, BNCR"
                required>
        </div>
        <div class="form-row">
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <select id="moneda" name="moneda" class="form-control">
                    <option value="CRC" <?= ($cuenta['moneda'] ?? 'CRC') === 'CRC' ? 'selected' : '' ?>>₡ Colones (CRC)
                    </option>
            ...
            <div class="form-group">
                ...
                <select id="negocio_id" name="negocio_id" class="form-control">
                    ...
                    <?php foreach ($negocios as $n): ?>
                        <option value="<?= $n['id'] ?>" <?= ($cuenta['negocio_id'] ?? '') == $n['id'] ? 'selected' : '' ?>>
        ...
        <div style="display:flex;gap:.75rem;margin-top:1rem;">
            ...
            <a href="/public/?c=cuentas&a=index" class="btn btn-secondary">Cancelar</a>
        </div>
    </form>
</div>