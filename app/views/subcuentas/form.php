<div class="page-header">
    <div>
        <h1>👛 <?= $accion ?> Bolsillo</h1>
    </div>
    <a href="/public/?c=subcuentas&a=index" class="btn btn-secondary">← Volver</a>
</div>
    ...
    <form method="POST">
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <input type="text" id="nombre" name="nombre" class="form-control"
                    value="<?= htmlspecialchars($subcuenta['nombre'] ?? '') ?>"
                    placeholder="Ej: Ahorro, Gastos, Salario" required>
            </div>
            <?php if ($accion === 'Crear'): ?>
                <div class="form-group">
        ...
        <div class="form-group">
            ...
            <textarea id="descripcion" name="descripcion" class="form-control"
                placeholder="Ej: Para gastos del mes"><?= htmlspecialchars($subcuenta['descripcion'] ?? '') ?></textarea>
        </div>
        <div style="display:flex;gap:.75rem;margin-top:1rem;">
            <button type="submit" class="btn btn-primary"><?= $accion ?> Bolsillo</button>
            <a href="/public/?c=subcuentas&a=index" class="btn btn-secondary">Cancelar</a>
        </div>
    </form>
</div>