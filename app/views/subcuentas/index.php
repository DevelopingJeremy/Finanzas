...
<?php if (empty($subcuentas)): ?>
    <div class="card">
        <div class="empty-state">
            ...
            <h3>Sin bolsillos creados</h3>
            <p>Crea bolsillos para dividir el dinero de tus cuentas.</p><a href="/public/?c=subcuentas&a=create"
                class="btn btn-primary mt-3">Crear Bolsillo</a>
        </div>
    </div>
<?php else: ?>
    <div class="card">
                        ...
                        <tr>
                            ...
                            <td>
                                <div style="display:flex;gap:.4rem;">
                                    <a href="/public/?c=subcuentas&a=edit&id=<?= $s['id'] ?>"
                                        class="btn btn-secondary btn-sm">✏️</a>
                                    <button
                                        onclick="confirmDelete('/public/?c=subcuentas&a=delete&id=<?= $s['id'] ?>','<?= htmlspecialchars($s['nombre']) ?>')"
